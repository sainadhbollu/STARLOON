...
const Testing = (props) => {
  ...
  updateEmgValue = () => {
    intervalId = setInterval(() => {
      ...
      if (pairedDevices[0].emg == 320) stopTesting();
      setPairedDevices([...pairedDevices]);
    }, 2000);
  };
  ...
  updateSelectedTheme = (theme) => {
    props.params.callBacks.updateSelectedTheme(theme);
  ...
  return (
    <View style={{ height: "100%" }}>
      <View style={{ height: "10%", width: "100%", flexDirection: "row" }}>
        ...
        >
          <TouchableOpacity onPress={() => setSelectTheme(true)}>
            <Image
              style={{
                width: 25,
                height: 25,
              ...
              source={require("../assets/images/emg.png")}
            />
          </TouchableOpacity>
        </View>
      </View>
      <View style={{ height: "80%" }}>
        {props.params.selectedTheme == 1 && (
            ...
            {pairedDevices.map((device, key) => {
              return (
                <View
                  key={key}
                  style={{
                    width: pairedDevices.length >= 2 ? "50%" : "100%",
                  }}
                >
                  <View style={{ height: "70%", alignItems: "center" }}>
                    <View
                      style={{
                        height: 100 - (device.emg * 100) / 320 + "%",
                        width: 48,
        ...
        {props.params.selectedTheme == 2 && (
          ...
          >
            ...
            {props.params.selectedTheme == 2 && pairedDevices.length == 1 && (
              <View
                style={{
                  height: "50%",
                  justifyContent: "center",
      ...
      <Modal isVisible={selectTheme} style={{ marginTop: 10 }}>
        <View
          style={{
            width: "70%",
            height: "70%",
        ...
        >
          ...
          >
            <TouchableOpacity
              ...
              onPress={() => updateSelectedTheme(1)}
            >
              <View
                style={{ width: 30, alignItems: "center", marginRight: 10 }}
              >
                <Image
                  style={{
                    width: 12,
            ...
            >
              ...
              >
                <Image
                  ...
                  source={require("../assets/images/theme-2.png")}
                />
              </View>
              <Text
                style={{
